...
var data = {
    ...
    "english": {
        ...
        "apropos" : "About me",
        "apropos_para": "I am Boubacar, passionate about the world of programming, I specialized in as an <a3>Application Developer Designer,</a3> I acquired skills in several programming languages ​​and frameworks, with particular experience in Java and React. <br> Graduated in web development, I have acquired more than <a2>3 years </a2>of experience in this field. Motivated by stimulating challenges, I am driven by the desire to implement practical my skills, to progress professionally and to contribute to innovative projects. <br> Do not hesitate to contact me to discuss any collaboration opportunities. <br> Thank you for your visit !",
    ...
    "italiano": {
        ...
        "apropos_para": "Sono Boubacar, appassionato del mondo della programmazione, I specializzato In come <a3>Application Developer Designer,</a3> ho acquisito competenze in diversi linguaggi e framework di programmazione, con particolare esperienza in Java e React. <br> Laureato in sviluppo web, ho acquisito più di <a2>3 anni </a2>di esperienza in questo campo. Motivato da sfide stimolanti, sono spinto dal desiderio di implementare pratico le mie competenze, per progredire professionalmente e per contribuire a progetti innovativi. <br> Non esitate a contattarmi per discutere eventuali opportunità di collaborazione. <br> Grazie per la vostra visita !",
